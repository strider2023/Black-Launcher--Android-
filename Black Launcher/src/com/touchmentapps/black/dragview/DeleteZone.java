...
public class DeleteZone extends RelativeLayout implements DropTarget {
	...
	private DeleteLaunchItemHandler deleteHandler;
 ...
 */
	...
	public boolean acceptDrop(DragSource source, int x, int y, int xOffset,
			int yOffset, DragView dragView, Object dragInfo) {
		return isEnabled() && source.canDelete();
	}
 ...
 */
	...
	public void setOnItemDeleted(DeleteLaunchItemHandler deleteHandler) {
